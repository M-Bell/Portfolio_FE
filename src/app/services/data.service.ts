...
export class DataService {
  ...
  private projects: Project[] = [
      ...
      media: [
        {
          id: 0,
          type: 'img',
          address: 'https://res.cloudinary.com/dg9jxlzdz/image/upload/v1727644480/cookshub_screen_1_ceacox.png',
          name: 'Main page',
        ...
        },
        {
          id: 1,
          type: 'img',
          address: 'https://res.cloudinary.com/dg9jxlzdz/image/upload/v1727644478/cookshub_screen_3_nybnnw.png',
          name: 'Recipe page',
          description: undefined,
        },
        {
          id: 2,
          type: 'img',
          address: 'https://res.cloudinary.com/dg9jxlzdz/image/upload/v1727644478/cookshub_screen_2_h6bful.png',
          name: 'User page',
          description: undefined,
        },
        {
          id: 3,
          type: 'img',
          address: 'https://res.cloudinary.com/dg9jxlzdz/image/upload/v1727644477/cookshub_screen_4_cd41zl.png',
    ...
    },
    {
      ...
      description: 'A personal portfolio website to showcase my projects, skills, and experience. The website is built using Angular framework for the frontend and Java/Spring Boot backend API integration. It features a responsive design, dynamic project data, and smooth navigation.',
      ...
      media: [
        {
          id: 5,
          type: 'img',
          address: 'https://res.cloudinary.com/dg9jxlzdz/image/upload/v1727644566/Architecture_eng_v5gnnp.png',
        ...
        },
        {
          id: 4,
          type: 'video',
          address: 'https://res.cloudinary.com/dg9jxlzdz/video/upload/v1727644591/Application_demo_small_uhvry7.mp4',
          name: '',
          description: undefined,
        },
      ],
  ...
  getProjectById(id: string): Observable<Project | undefined> {
    return of(
      this.projects.find((project) => project.id === parseInt(id))
    );
  }
}
